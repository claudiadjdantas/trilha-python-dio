...
## Criar usuário
O programa deve armazenar em uma **lista**, um usuário é composto por: **nome, data de nascimento, cpf** e **endereço**. O endereço é uma string com o formato: **logradouro, número, bairro, cidade, sigla estado**.
...
O usuário pode ter ___mais de uma conta___, mas uma conta pertence a somente ___um usuário___.
